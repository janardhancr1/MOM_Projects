...
class Application_Form_Reviewedit extends Application_Form_MainForm
{
	...
	public function init()
	{
		...
		if($form1_Values['longest_stop70'] != $rt_results_level_3[0]['longest_stop70'])
		{
			//$rt_original_table_ids_prepared[0]= "Select from list";
			$longest_stop70 = new Zend_Form_Element_Text('longest_stop70',array('style'=>'width:150px;'));
			$longest_stop70->setValue($form1_Values['longest_stop70']);

			$before_longest_stop70 = new Zend_Form_Element_Text('before_longest_stop70',array("readonly" => "readonly"));
			$before_longest_stop70->setLabel('longest stop 70');

			if($rt_results_level_3)
								$before_longest_stop70->setValue($rt_results_level_3[0]['longest_stop70']);

			$longest_stop70->setDecorators(array(
			'ViewHelper',
			'Description',
			array(array('data'=>'HtmlTag'), array('tag' => 'td', 'align' => 'center')),
			array(array('row'=>'HtmlTag'), array('tag'=>'tr', 'closeOnly' => true))
			...
			$before_longest_stop70->setDecorators(array(
			'ViewHelper',
			'Description',
			array(array('data'=>'HtmlTag'), array('tag' => 'td', 'align' => 'center')),
			array('Label', array('tag' => 'td','style' => 'float:right;')),
			...
			$this->addElements(array($before_longest_stop70,$longest_stop70));
		}
	...
	if($form1_Values['image1'] != $rt_results_level_3[0]['image'])
		{
			...
			if(isset($form1_Values['image1']))
				$before_image->setImage("/images/".$form1_Values['image1']);
			else
