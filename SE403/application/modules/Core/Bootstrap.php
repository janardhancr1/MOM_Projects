 ...
 * @version    $Id: Bootstrap.php 7250 2010-09-01 07:42:35Z john $
 * @author     John
 */
...
class Core_Bootstrap extends Engine_Application_Bootstrap_Abstract
{
  ...
  public function run()
  {
    ...
    // Debug :P
    //Zend_Auth::getInstance()->getStorage()->write(1);
  ...
  protected function _initLocale()
  {
    ...
    $defaultLanguage = Engine_Api::_()->getApi('settings', 'core')->core_language_default;
    if (!$translate->isAvailable($localeObject->getLanguage())) {
