...
<div class='clear'>
  <div class='settings'>
    <form class="global_form">
      <div>
      <h3><?php echo $this->translate("Classified Entry Sub Categories") ?></h3>
      <p class="description">
        <?php echo $this->translate("CLASSIFIEDS_VIEWS_SCRIPTS_ADMINSETTINGS_CATEGORIES_DESCRIPTION") ?>
      </p>
       <h3><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'classified', 'controller' => 'settings', 'action' => 'categories', 'id' =>$this->parent_cat_id), $this->translate(' Back To Categories'), array(
      ...
      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'classified', 'controller' => 'settings', 'action' => 'add-subcategory', 'id' =>$this->parent_cat_id), $this->translate('Add New Sub Category'), array(
