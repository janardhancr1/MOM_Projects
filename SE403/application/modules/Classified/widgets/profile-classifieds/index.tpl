...
<?php if($this->paginator->getTotalItemCount() > $this->items_per_page):?>
  <?php echo $this->htmlLink($this->url(array('user' => Engine_Api::_()->core()->getSubject()->getIdentity()), 'classified_browse'), $this->translate('View All Listings'), array('class' => 'buttonlink item_icon_classified')) ?>
<?php endif;?>