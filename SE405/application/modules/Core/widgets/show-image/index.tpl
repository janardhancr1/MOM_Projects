...
<div style='float: left; width: 500px; padding: 0px 10px 0px 10px;'>
	...
	<div style='padding-left:5px;float:left'>
		<img src='./application/modules/Core/externals/images/momshomeimage.gif' width='460px' border='0' alt='' />
	</div>

</div>
<div style='float: left; width: 400px;padding-right:5px; padding-left:100px;'>
