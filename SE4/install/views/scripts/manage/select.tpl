 ...
 * @version    $Id: select.tpl 6641 2010-06-30 01:22:51Z john $
 * @author     John
 */
?>
  ...
  <div class="package_uploader_main">
    ...
    <div id="upload-status" style="display: none;">
      <div class="upload-buttons" id="upload-buttons">
        <a href="javascript:void(0);" id="upload-browse" class="buttonlink package_uploader_choosepackages">Add Packages</a>
...
<form action="<?php echo $this->url(array('action' => 'prepare')) ?>" method="post">
  ...
  <ul class="selected-packages-list extracted-packages-list">
    ...
    <?php endforeach; ?>
    <?php foreach( (array) $this->extractedPackages as $package ): ?>
