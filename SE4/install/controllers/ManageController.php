 ...
 * @version    $Id: ManageController.php 6682 2010-07-01 23:45:46Z john $
 * @author     John
 */
...
class ManageController extends Zend_Controller_Action
{
  ...
  public function init()
  {
    ...
    // Create navigation
    $this->view->navigation = $this->getMainNavigation();
  ...
  public function prepareAction()
  {
    ...
    if( $flush || empty($this->_session->packages) ) {
      $packages = $this->_session->packages = $this->_getParam('packages');
    } else {
  ...
  public function getMainNavigation($action = null)
  {
