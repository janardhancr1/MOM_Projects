 ...
 * @version    $Id: InstallController.php 6641 2010-06-30 01:22:51Z john $
 * @author     John
 */
...
class InstallController extends Zend_Controller_Action
{
      ...
      'tests' => array(
        ...
        array(
          ...
          'tests' => array(
            ...
            array(
              'type' => 'FilePermission',
              'path' => APPLICATION_PATH . '/temporary/cache',
              'value' => 7,
            ),
            array(
              'type' => 'FilePermission',
              'path' => APPLICATION_PATH . '/temporary/log',
              'recursive' => true,
              'value' => 7,
            ),
            array(
              'type' => 'FilePermission',
              'path' => APPLICATION_PATH . '/temporary/package',
              'value' => 7,
            ),
            array(
              'type' => 'FilePermission',
              'path' => APPLICATION_PATH . '/temporary/package/archives',
              'value' => 7,
            ),
            array(
              'type' => 'FilePermission',
            ...
            array(
              'type' => 'FilePermission',
              'path' => APPLICATION_PATH . '/temporary/package/repositories',
              'value' => 7,
            ),
            array(
              'type' => 'FilePermission',
              'path' => APPLICATION_PATH . '/temporary/scaffold',
              'value' => 7,
            ),
            array(
              'type' => 'FilePermission',
              'path' => APPLICATION_PATH . '/temporary/session',
              'value' => 7,
            ),
          ),
        ),
        ...
        array(
          ...
          'path' => APPLICATION_PATH . '/application/settings',
          'value' => 7,
          'recursive' => true,
          'messages' => array(
        ...
        array(
          ...
          'path' => APPLICATION_PATH . '/application/packages',
          'value' => 7,
          'recursive' => true,
          'messages' => array(
        ...
        array(
          ...
          'path' => APPLICATION_PATH . '/install/config/auth.php',
          'value' => 7,
          'recursive' => false,
          'messages' => array(
  ...
  public function dbCreateAction()
  {
    ...
    try {
	  ...
	  echo $fullSql;
	  //exit;
      /*$queries = Engine_Package_Utilities::sqlSplit($fullSql);
