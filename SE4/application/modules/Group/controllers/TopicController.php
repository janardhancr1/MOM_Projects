 ...
 * @version    $Id: TopicController.php 6516 2010-06-23 01:15:53Z shaun $
 * @author     John
 */
...
class Group_TopicController extends Core_Controller_Action_Standard
{
  ...
  public function createAction()
  {
    ...
    $this->view->group = $group = $this->_helper->api()->core()->getSubject();
    if( !$group instanceof Group_Model_Group )
    {
