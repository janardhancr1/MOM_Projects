 ...
 * @version    $Id: IndexController.php 6516 2010-06-23 01:15:53Z shaun $
 * @author     John
 */
...
class Group_IndexController extends Core_Controller_Action_Standard
{
  ...
  public function createAction()
  {
    ...
    try
    {
      ...
      {
        if( $role === 'officer' ) $role = $group->getOfficerList();
        $auth->setAllowed($group, $role, 'invite', ($i <= $commentMax) );
      }
      ...
      $auth->setAllowed($group, $group->getOfficerList(), 'photo.edit');
      $auth->setAllowed($group, $group->getOfficerList(), 'topic.edit');
