 ...
 * @version    $Id: MemberController.php 6516 2010-06-23 01:15:53Z shaun $
 * @author     John
 */
...
class Group_MemberController extends Core_Controller_Action_Standard
{
  ...
  public function requestAction()
  {
    ...
    if( $this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost()) )
    {
      ...
      {
        $subject->membership()->addMember($viewer)->setUserApproved($viewer);
        Engine_Api::_()->getDbtable('notifications', 'activity')->addNotification($owner, $subject, $viewer, 'group_approve');
        $db->commit();
      }
      catch( Exception $e )
      {
