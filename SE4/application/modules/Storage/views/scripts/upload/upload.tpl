 ...
 * @version    $Id: upload.tpl 5898 2010-05-19 23:45:49Z john $
 * @author     Sami
 */
?>
...
<div id="demo-status" class="hide">
  ...
  <div>
    ...
    <a class="buttonlink icon_clearlist" href="javascript:void(0);" id="demo-clear" style='display: none;'>Clear List</a>
  </div>
