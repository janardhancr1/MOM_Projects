 ...
 * @version    $Id: General.php 6505 2010-06-22 23:27:39Z shaun $
 * @author     John
 */
...
class Activity_Form_Admin_Settings_General extends Engine_Form
{
  public function init()
  {
    ...
    $type_table = Engine_Api::_()->getDbTable('actionTypes', 'activity');
    $types = $type_table->fetchAll();
    // Form should handle translation, there's no need to trans
    //$translate = Zend_Registry::get('Zend_Translate');
    foreach ($types as $type)
    {
      $key = 'ADMIN_ACTIVITY_TYPE_' . strtoupper($type->type);
      $options[$type->type] = $key;//$translate->_($key);
