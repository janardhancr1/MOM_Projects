 ...
 * @version    $Id: IndexController.php 6627 2010-06-29 02:40:28Z steve $
 * @author     John
 */
...
class Activity_IndexController extends Core_Controller_Action_Standard
{
  public function init()
  {
    ...
    $ajaxContext
      ->addActionContext('like', 'json')
      ->addActionContext('unlike', 'json')
      ->addActionContext('delete', 'json')
      ->addActionContext('comment', 'json')
      ->addActionContext('viewcomment', 'json')
      ->initContext();
  }
  ...
  public function likeAction()
  {
    ...
    else if ('json'===$this->_helper->ajaxContext()->getCurrentContext())
    {
