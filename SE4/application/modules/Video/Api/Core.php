 ...
 * @version    $Id: Core.php 6302 2010-06-12 00:47:21Z jung $
 * @author     Jung
 */
...
class Video_Api_Core extends Core_Api_Abstract
{
  ...
  public function getVideosSelect($params = array())
  {
    ...
    if( !empty($params['tag']) )
    {
      $select
        ...
        ->from($rName)
        ->joinLeft($tmName, "$tmName.resource_id = $rName.video_id")
  ...
  {
    return $this->api()->getDbtable('categories', 'video')->fetchAll();
  }
  public function getCategory($category_id)
  {
    $category = new Video_Model_Category($category_id);
    return $category;
  }
