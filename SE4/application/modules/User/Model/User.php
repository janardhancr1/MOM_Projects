 ...
 * @version    $Id: User.php 6640 2010-06-30 01:15:38Z jung $
 * @author     John
 */
...
{
  protected $_searchColumns = array('search', 'displayname', 'username');
  /**
  ...
  {
    return new Engine_ProxyObject($this, $this->api()->getModel('Status_Standard', 'core'));
  }
