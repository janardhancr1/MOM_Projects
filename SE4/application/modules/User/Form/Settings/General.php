 ...
 * @version    $Id: General.php 6590 2010-06-25 19:40:21Z john $
 * @author     Steve
 */
...
class User_Form_Settings_General extends Engine_Form
{
  ...
  public function getItem()
  {
    if( null === $this->_item )
    {
      throw new User_Model_Exception('No item set in User_Form_Signup_Account');
    }
  ...
  public function init()
  {
   ...
   // Init default locale
    ...
    // Init emails
    $this->addElement('MultiCheckbox', 'emailAlerts', array(
      'label' => 'Email Alerts',
    ...
    /*
    $this->emailAlerts
                ->addMultiOption('onFriendRequest',   'When I receive a friend request')
                ->addMultiOption('onEventComment',    'When a comment is posted on an event I created')
                ->addMultiOption('onEventPhotoTag',   'When someone tags a photo in an event I lead')
                ->addMultiOption('onPhotoTagged',     'When I am tagged in a group photo')
                ->addMultiOption('onBlogComment',     'When a comment is posted on one of my blog entries')
                ;
    // @todo identify which checkboxes are checked by adding them to this array
    $this->emailAlerts->setValue(array(
        'onEventPhotoTag'
      ));
     *
     */
