 ...
 * @version    $Id: list.tpl 6159 2010-06-05 02:12:43Z alex $
 * @author     Jung
 */
?>
...
<div class='layout_right'>
  <div class='blogs_gutter'>
    ...
    <ul class='blogs_gutter_options'>
      <li>
        <a href='<?php echo $this->url(array('user_id' => $this->owner->getIdentity()), 'blog_view') ?>' class='buttonlink icon_blog_viewall'><?php echo $this->translate('View All Entries');?></a>
      </li>
    </ul>
