 ...
 * @version    $Id: view.tpl 4936 2010-04-12 18:50:21Z jung $
 * @author     Jung
 */
?>
...
<div class='layout_right'>
  <div class='blogs_gutter'>
    ...
    <ul class='blogs_gutter_options'>
      <li>
        <?php echo $this->htmlLink($this->url(array('user_id' => $this->blog->owner_id), 'blog_view'), $this->translate('View All Entries'), array('class' => 'buttonlink icon_blog_viewall')) ?>
      </li>
      <?php if ($this->blog->isOwner($this->viewer()) || $this->can_edit):?>
        <li>
          <a href='<?php echo $this->url(array(), 'blog_create', true) ?>' class='buttonlink icon_blog_new'><?php echo $this->translate('Write New Entry');?></a>
        </li>
        <li>
          <a href='<?php echo $this->url(array('blog_id' => $this->blog->blog_id), 'blog_edit', true) ?>' class='buttonlink icon_blog_edit'><?php echo $this->translate('Edit This Entry')?></a>
        </li>
        <li>
          <a href='<?php echo $this->url(array('blog_id' => $this->blog->blog_id), 'blog_delete', true) ?>' class='buttonlink icon_blog_delete'><?php echo $this->translate('Delete This Entry')?></a>
        </li>
      <?php endif; ?>
    </ul>
