...
<p>
  <?php echo $this->translate("ANSWER_VIEWS_SCRIPTS_ADMINMANAGE_INDEX_DESCRIPTION") ?>
</p>
  ...
  <table class='admin_table'>
    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        <tr>
          <td><input type='checkbox' class='checkbox' value="<?php echo $item->answer_id ?>"/></td>
...
<?php else: ?>
  <div class="tip">
    <span>
      <?php echo $this->translate("There are no questions created yet.") ?>
    </span>
  </div>
<?php endif; ?>
