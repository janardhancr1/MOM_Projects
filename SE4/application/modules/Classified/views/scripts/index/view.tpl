...
<div class='layout_right'>
  <div class='classifieds_gutter'>
    <div class='classifieds_gutter_photo'>
      <?php echo $this->htmlLink($this->user($this->classified->owner_id)->getHref(), $this->itemPhoto($this->user($this->classified->owner_id))) ?>
    </div>
    <a href='<?php echo $this->url(array('id' => $this->classified->owner_id), 'user_profile') ?>' class="classifieds_gutter_name"><?php echo $this->user($this->classified->owner_id)->getTitle() ?></a>
    <ul class='classifieds_gutter_options'>

      <?php if ($this->classified->owner_id == $this->viewer->getIdentity()||$this->can_edit):?>
        <li>
          <a href='<?php echo $this->url(array('classified_id' => $this->classified->classified_id), 'classified_edit', true) ?>' class='buttonlink icon_classified_edit'><?php echo $this->translate('Edit This Listing');?></a>
        </li>
        ...
        <li>
          <?php if( !$this->classified->closed ): ?>
            <a href='<?php echo $this->url(array('classified_id' => $this->classified->classified_id, 'closed' => 1), 'classified_close', true) ?>' class='buttonlink icon_classified_close'><?php echo $this->translate('Close Listing');?></a>
          <?php else: ?>
            <a href='<?php echo $this->url(array('classified_id' => $this->classified->classified_id, 'closed' => 0), 'classified_close', true) ?>' class='buttonlink icon_classified_open'><?php echo $this->translate('Open Listing');?></a>
          <?php endif; ?>
        </li>
        <li>
          <a href='<?php echo $this->url(array('classified_id' => $this->classified->classified_id), 'classified_delete', true) ?>' class='buttonlink icon_classified_delete'><?php echo $this->translate('Delete Listing');?></a>
        </li>
      <?php endif; ?>
    </ul>
