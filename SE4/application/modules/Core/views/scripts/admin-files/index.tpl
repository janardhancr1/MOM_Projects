 ...
 * @version    $Id: index.tpl 6597 2010-06-25 23:37:46Z john $
 * @author     John
 */
?>
...
<h2><?php echo $this->translate("File Manager") ?></h2>
<p>
...
<?php if(count($this->contents) > 0): $i = 0; ?>
  <div class="admin_files_wrapper">
    ...
    <div class="admin_files_pages">
      ...
      Showing <?php echo $pageInfo->firstItemNumber ?>-<?php echo $pageInfo->lastItemNumber ?> of <?php echo $pageInfo->totalItemCount ?> files.
      <span>
        ...
        <?php foreach( $this->paginator as $content ): $i++; $id = 'admin_file_' . $i; $contentKey = $content['rel']; ?>
          <li class="admin_file admin_file_type_<?php echo $content['type'] ?>" id="<?php echo $id ?>">
            ...
            <div class="admin_file_options">
              <?php echo $this->htmlLink('javascript:void(0)', 'copy URL', array('onclick' => 'fileCopyUrl(\''.$contentKey.'\');')) ?>
