 ...
 * @version    $Id: referrers.tpl 6657 2010-07-01 01:38:38Z john $
 * @author     John
 */
?>
...
<?php if( count($this->referrers) > 0 ): ?>
  ...
  <div>
    <?php echo $this->htmlLink('javascript:void(0);', 'Clear Referrer List', array(
      ...
      'onclick' => "return confirm('{$this->string()->escapeJavascript($this->translate("Are you sure you want to clear the referrers?"))}'');",
    )) ?>
  </div>
