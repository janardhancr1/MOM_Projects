 ...
 * @version    $Id: search.tpl 6590 2010-06-25 19:40:21Z john $
 * @author     John
 */
?>
  ...
  <div class="pages">
    <ul class="paginationControl">
      <?php if (isset($this->previous)): ?>
        <li>
          <a href="<?php echo $this->url(array_merge($params, array('page' => $this->previous))) . $query; ?>"><?php echo $this->translate('&#171; Previous') ?></a>
        </li>
      <?php endif; ?>
      ...
      <?php if (isset($this->next)): ?>
        <li>
          <a href="<?php echo $this->url(array_merge($params, array('page' => $this->next))) . $query; ?>"><?php echo $this->translate('Next &#187;') ?></a>
        </li>
      <?php endif; ?>
    </ul>
  </div>
