      ...
      <tr>
        ...
        <td class="admin_table_options">
          ...
          <?php if( $this->defaultLanguage != $locale ): ?>
            | <?php echo $this->htmlLink('javascript:void(0);', 'make default', array('onclick' => 'changeDefaultLanguage(\'' . $locale . '\');')) ?>
            | <?php echo $this->htmlLink(array('module'=>'core','controller'=>'language','action'=>'delete',  'locale'=>$locale), 'delete', array('class'=>'smoothbox')) ?>
          <?php else: ?>
