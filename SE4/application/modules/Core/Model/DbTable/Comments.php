 ...
 * @version    $Id: Comments.php 6590 2010-06-25 19:40:21Z john $
 * @author     John
 */
...
class Core_Model_DbTable_Comments extends Engine_Db_Table
{
  ...
  public function removeComment(Core_Model_Item_Abstract $resource, /*Core_Model_Item_Abstract $poster,*/ $comment_id)
  {
    ...
    // Must be owner or commenter
    //if( ($poster->getType() != $row->poster_type || $poster->getIdentity() != $row->poster_id) && $poster->getGuid() != $resource->getGuid() )
    //{
    //  throw new Core_Model_Exception('Only poster or commenter can delete');
    //}
