...
class Core_AdminAdsController extends Core_Controller_Action_Admin
{
  ...
  public function editAction()
  {
    ...
    else
    {
      ...
      if($networks){
        $form->getElement('ad_networks')->setValue(Zend_Json_Decoder::decode($campaign->network));
      }
      $form->getElement('ad_levels')->setValue(Zend_Json_Decoder::decode($campaign->level));
