 ...
 * @version    $Id: LinkController.php 6590 2010-06-25 19:40:21Z john $
 * @author     John
 */
...
class Core_LinkController extends Core_Controller_Action_Standard
{
  ...
  public function previewAction()
  {
    ...
    try
    {
      ...
      else if( empty($baseUrlInfo['path']) )
      {
      ...
      if( APPLICATION_ENV == 'development' )
      {
        ...
        //$this->view->baseUrlInfo = $baseUrlInfo;
        //$this->view->responseBody = $response->getBody();
      }
    }
