 ...
 * @version    $Id: CommentController.php 6590 2010-06-25 19:40:21Z john $
 * @author     John
 */
...
class Core_CommentController extends Core_Controller_Action_Standard
{
  ...
  public function deleteAction()
  {
    ...
    // Process
    $db = $subject->comments()->getTable()->getAdapter();
    $db->beginTransaction();

    try
    {
      $subject->comments()->removeComment($viewer, $form->getValue('comment_id'));
