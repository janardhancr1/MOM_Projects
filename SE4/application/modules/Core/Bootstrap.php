 ...
 * @version    $Id: Bootstrap.php 6590 2010-06-25 19:40:21Z john $
 * @author     John
 */
...
class Core_Bootstrap extends Engine_Application_Bootstrap_Abstract
{
  ...
  protected function _initManifest()
  {
    // Load from cache
    $cached = false;
    #var_dump($this->getContainer()->cache);exit;
    if( isset($this->getContainer()->cache) )
    {
  ...
  protected function _initSession()
  {
    ...
    Zend_Session::setSaveHandler(new $saveHandler($options['saveHandler']['params']));
  ...
  protected function _initContent()
  {
    ...
    Zend_Controller_Action_HelperBroker::getStack()->offsetSet(10, $contentRenderer);
