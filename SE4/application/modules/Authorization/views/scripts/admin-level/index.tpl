 ...
 * @version    $Id: index.tpl 6626 2010-06-29 02:19:32Z jung $
 * @author     John
 */
?>
...
<div class="admin_results">
  <div>
    <?php echo $this->htmlLink(array('action' => 'create', 'reset' => false), 'Add Member Level', array(
      'class' => 'buttonlink',
      'style' => 'background-image: url(application/modules/Authorization/externals/images/admin/add.png);'
    )) ?>
  </div>
  <div>
      ...
      <?php foreach( $this->paginator as $item ): ?>
        ...
        <td><input <?php if ($item->flag) echo 'disabled';?> type='checkbox' class='checkbox' value="<?php echo $item->level_id?>"></td>
          ...
          <td class="admin_table_centered">
            ...
            <?php else: ?>
              <?php echo $this->formRadio('default', $item->level_id, array('onchange' => "setDefault({$item->level_id});",'disable'=>($item->flag)), '') ?>
            <?php endif; ?>
          </td>
