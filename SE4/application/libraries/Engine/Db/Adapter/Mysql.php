...
/**
 * @see Engine_Db_Statement_Mysql
 */
//require_once "Engine/Db/Statement/Mysql.php";

class Engine_Db_Adapter_Mysql extends Zend_Db_Adapter_Abstract
{
    /**
    ...
    {
        //require_once "Engine/Db/Adapter/Mysql/Exception.php";
        if($message === null) {
            $message = mysql_error($this->_connection)." (".mysql_errno($this->_connection).")";
        }
        throw new Engine_Db_Adapter_Mysql_Exception($message);
    }
    ...
    {
        return new Engine_Db_Statement_Mysql($this, $sql);
    }
