 ...
 * @version    $Id: Gd.php 6168 2010-06-07 20:37:42Z john $
 * @todo       documentation
 */
...
class Engine_Image_Adapter_Gd extends Engine_Image
{
  ...
  */
  ...
  public function open($file)
  {
    ...
    if( !$info )
    {
      throw new Engine_Image_Adapter_Exception("Specified file is not an image or does not exist");
    }
  ...
  public function write($file = null, $type = 'jpeg')
  {
    ...
    if( !$result )
    {
      throw new Engine_Image_Adapter_Exception("Unable to write image to file");
    }
