...
<div class='page_header'><img src='./images/icons/event_event48.gif' border='0' class='icon_big'>{lang_print id=3000007}
...
<td style='width: 200px; vertical-align: top;'>
  ...
  <div style='padding: 10px; background: #F2F2F2; border: 1px solid #BBBBBB; font-weight: bold;'>
    <div style='line-height: 16px;'>
      ...
      <td style='padding-left:10px'>{lang_print id=3000208}&nbsp;</td>
      <td>
