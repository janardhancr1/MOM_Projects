...
{* $Id: admin_viewmusic.tpl 11 2009-01-11 06:03:58Z john $ *}
...
{else}
  ...
  <table cellpadding='0' cellspacing='0' class='list'>
    ...
    <tr class='{cycle values="background1,background2"} seMusicRow' id="seMusic_{$entries[music_loop].music_id}">
      ...
      <td class='item'>
        [ <a href="javascript:void(0);" onclick="SocialEngine.Music.deleteMusic({$entries[music_loop].music_id});">{lang_print id=155}</a> ]
  ...
  <div style='display: none;' id='confirmmusicdelete'>
    ...
    <br>
    <input type='button' class='button' value='{lang_print id=175}' onClick='parent.TB_remove();parent.SocialEngine.Music.deleteMusicConfirm(parent.SocialEngine.Music.currentConfirmDeleteID);'> <input type='button' class='button' value='{lang_print id=39}' onClick='parent.TB_remove();'>
  </div>
