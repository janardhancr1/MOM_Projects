...
<div class='page_header'><a href='forum.php'>{lang_print id=6000056}</a> &#187; <a href='forum_view.php?forum_id={$forum_info.forum_id}'>{lang_print id=$forum_info.forum_title}</a></div>
