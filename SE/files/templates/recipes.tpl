...
<div class='page_header'>{lang_sprintf id=7000027 1=$owner->user_displayname 2=$url->url_create("profile", $owner->user_info.user_username) 3=$url->url_create("recipes", $owner->user_info.user_username)}</div>
