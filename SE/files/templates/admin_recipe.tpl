...
<table cellpadding='0' cellspacing='0' width='600'>
  ...
  <tr>
    <td class='setting1'>{lang_print id=7000023}</td>
  </tr>
<tr>
<td class='setting2'>
  ...
  <tr>
    ...
    <td><label for='setting_poll_enabled_1'>{lang_print id=7000024}</label></td>
  </tr>
  <tr>
    ...
    <td><label for='setting_poll_enabled_0'>{lang_print id=7000025}</label></td>
  </tr>
  </table>
</td>
</tr>
...
<table cellpadding='0' cellspacing='0' width='600'>
  <tr>
    <td class='header'>{lang_print id=7000109}</td>
  </tr>
  <tr>
    <td class='setting1'>{lang_print id=7000110}</td>
  </tr>
  <tr>
