...
/* $Id: browse_polls.php 59 2009-02-13 03:25:54Z john $ */
...
// GET Today's Poll
$todays_poll = $poll->poll_list($page_vars[0], 2, $s, $where, TRUE);

// GET Popular Poll
$s = "poll_views DESC";
$popular_poll = $poll->poll_list($page_vars[0], $polls_per_page, $s, $where, TRUE);
...
$smarty->assign('todays_polls', $todays_poll);
$smarty->assign('popular_polls', $popular_poll);
$smarty->assign('todays_total', $total_polls);
$smarty->assign('p', $page_vars[1]);
$smarty->assign('maxpage', $page_vars[2]);
$smarty->assign('p_start', $page_vars[0]+1);
$smarty->assign('p_end', $page_vars[0]+count($todays_poll));
$smarty->assign('s', $s);
$smarty->assign('v', $v);
include "footer.php";
?>