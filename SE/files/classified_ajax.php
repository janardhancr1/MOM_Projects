...
/* $Id: classified_ajax.php 53 2009-02-06 04:55:08Z john $ */
...
if( $task=="deleteclassified" )
{
  ...
  if( $user->user_exists && ((int)$user->level_info['level_classified_allow'] & 2) && $classified_id && $classified->classified_delete($classified_id) )
    echo '{"result":"success"}';
  else
    echo '{"result":"failure"}';
