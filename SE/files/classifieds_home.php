...
/* $Id: classifieds_home.php 152 2009-04-02 20:50:48Z john $ */

$page = "classifieds_home";
include "header.php";
...
if(isset($_POST['classified_search'])) { $classified_search = $_POST['classified_search']; } elseif(isset($_GET['classified_search'])) { $classified_search = $_GET['classified_search']; } else { $classified_search = 'What are you looking for?'; }
