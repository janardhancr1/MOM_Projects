...
/* $Id: functions_poll.php 12 2009-01-11 06:04:12Z john $ */
...
// OUTPUT:
function deleteuser_recipe($user_id)
{
	global $database;
...
// INPUT:
// OUTPUT:
function site_statistics_recipe(&$args)
{
	global $database;
...
function generate_where($where, $cond)
{
	if(!empty($where)){
		$where .= " AND " .$cond;
	} else {
