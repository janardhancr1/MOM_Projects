...
/* $Id: functions_music.php 42 2009-01-29 04:55:14Z john $ */
...
// INPUT: 
// OUTPUT: 
function site_statistics_music(&$args)
{
  global $database;
  ...
  $total = $database->database_fetch_assoc($database->database_query("SELECT COUNT(music_id) AS total FROM se_music"));
  $statistics['music'] = array(
    'title' => 4000107,
    'stat'  => (int) ( isset($total['total']) ? $total['total'] : 0 )
  );
}

// END site_statistics_music() FUNCTION
