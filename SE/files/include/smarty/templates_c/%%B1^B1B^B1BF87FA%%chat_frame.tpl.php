...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'chat_frame.tpl', 32, false),array('modifier', 'rand', 'chat_frame.tpl', 95, false),)), $this);
?><?php
SELanguage::_preload_multi(3500004,3500005,3500007,3500008,3500009,3500010,3500011,3500012,3500013,3500014,3500015,3500016,3500017,3500018,3500019,3500020,3500021,3500022);
SELanguage::load();
?><html>
<head>
...
<?php echo SELanguage::_get(3500004); ?>
<br><br>
<?php echo sprintf(SELanguage::_get(3500005), $this->_tpl_vars['user']->user_displayname); ?>
<br><br>
...
<tr>
<td class='chat_header'><?php echo SELanguage::_get(3500007); ?></td>
...
' width='70' class='photo' border='0'><br><?php endif; 
 echo ((is_array($_tmp=$this->_tpl_vars['user']->user_displayname)) ? $this->_run_mod_handler('truncate', true, $_tmp, 15, '...', true) : smarty_modifier_truncate($_tmp, 15, '...', true)); ?>
</a></div>
...
<td class='chat_inputarea' style='height: 120px;'>
  ...
  <div class='buttons'>
    <div class='button' style='width: 25px;'><div class='button1' id='button_bold' onClick="button_toggle('button_bold');"><img src='./images/icons/chat_bold.png' border='0' class='icon' onselect="return false" alt='<?php echo SELanguage::_get(3500008); ?>'></div></div>
    <div class='button' style='width: 25px;'><div class='button1' id='button_italic' onClick="button_toggle('button_italic');"><img src='./images/icons/chat_italic.png' border='0' class='icon' alt='<?php echo SELanguage::_get(3500009); ?>'></div></div>
    <div class='button' style='width: 25px;'><div class='button1' id='button_underline' onClick="button_toggle('button_underline');"><img src='./images/icons/chat_underline.png' border='0' class='icon' alt='<?php echo SELanguage::_get(3500010); ?>'></div></div>
    <div class='button' style='width: 25px;'><div class='button1' id='button_smilie' onClick="button_picksmilie()"><img src='./images/icons/chat_smile.png' border='0' class='icon' alt='<?php echo SELanguage::_get(3500011); ?>'></div>
    ...
    <div class='button' style='width: 45px;'><div class='button_color1' id='button_color'><img src='./images/trans.gif' style='height: 16px; width: 100%;' border='0' onClick="button_pickcolor()" alt='<?php echo SELanguage::_get(3500012); ?>'>
  ...
  <img src='./images/icons/chat_clock1.gif' id='chat_timestamp_icon' border='0' class='icon' onClick='button_timestamp_toggle()' style='margin-top: 2px; margin-left: 2px;' alt='<?php echo SELanguage::_get(3500013); ?>'>
  <img src='./images/icons/chat_audio1.gif' id='chat_audio_icon' border='0' class='icon' onClick='button_audio_toggle()' style='margin-top: 2px; margin-left: 4px;' alt='<?php echo SELanguage::_get(3500014); ?>'>
...
<b><?php echo $this->_tpl_vars['user']->user_displayname_short; ?>
...
function chat_update() {
  ...
  setTimeout("chat_update_go()", '; 
 echo $this->_tpl_vars['setting']['setting_chat_update']; 
 echo ');
...
function ajaxFunction(task) {
  ...
  if(task == "chat_update") {
	  ...
	  for(var counter=0;counter<onlineusers.length;counter++)
    {
      ...
      displayname = onlineusers[counter].getElementsByTagName(\'displayname\')[0].firstChild.nodeValue;
	    output_users += "<div class=\'chat_onlineuser\' '; 
 if ($this->_tpl_vars['setting']['setting_chat_showphotos'] == 1): ?>style='text-align: center;'<?php endif; 
 echo '><a href=\'profile.php?user="+username+"\' target=\'_blank\'>";
	    '; 
 if ($this->_tpl_vars['setting']['setting_chat_showphotos'] == 1): 
 echo '
 ...
 echo ' 
	    if(displayname.length > 15) { displayname = displayname.substr(0, 12)+\'...\'; }
	    output_users += displayname+"</a><img src=\'./images/trans.gif\' border=\'0\'></div>";
          }
	  ...
	  if(onlineusers_num == "1") {
	    document.getElementById(\'chat_onlineusers_header\').innerHTML = "'; 
 echo sprintf(SELanguage::_get(3500015), '" + onlineusers_num + "'); 
 echo '";
	  } else {
	    document.getElementById(\'chat_onlineusers_header\').innerHTML = "'; 
 echo sprintf(SELanguage::_get(3500016), '" + onlineusers_num + "'); 
 echo '";
	  }
	...
	// USER WAS PROBABLY KICKED
	  ...
	  document.getElementById(\'chat_curtain\').innerHTML = "'; 
 echo SELanguage::_get(3500017); 
 echo '";
