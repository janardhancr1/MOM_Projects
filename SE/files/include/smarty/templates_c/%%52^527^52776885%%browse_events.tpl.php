<?php /* Smarty version 2.6.14, created on 2010-06-01 15:10:38
         compiled from browse_events.tpl */
?><?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'browse_events.tpl', 104, false),array('modifier', 'strip_tags', 'browse_events.tpl', 182, false),array('modifier', 'truncate', 'browse_events.tpl', 182, false),array('function', 'math', 'browse_events.tpl', 131, false),)), $this);
?><?php
SELanguage::_preload_multi(3000007,3000090,3000206,3000207,3000210,3000208,3000209,3000211,3000212,3000213,3000214,182,184,185,183,3000203,3000202,3000204,3000215,3000216,3000217);
SELanguage::load();
...
<div class='page_header'><img src='./images/icons/event_event48.gif' border='0' class='icon_big'><?php echo SELanguage::_get(3000007); ?>
<div class="page_header_small">Create, share and view events from moms everywhere!</div>
</div>
...
&v='+this.options[this.selectedIndex].value;">
      ...
      <td style='padding-left:10px'><?php echo SELanguage::_get(3000208); ?>&nbsp;</td>
      <td>
...
&s='+this.options[this.selectedIndex].value;">
      ...
      <td>
	  	<div class='mom_div_small'><a href='user_event.php' class='mom_div_small'><img src='./images/icons/plus16.gif' border='0' class='button'>Go to My Events</a></div>
	  </td>
      </tr>
      </table>
    </div>
...
<td valign='top'>
  ...
  <div style='padding: 5px; background: #F2F2F2; border: 1px solid #BBBBBB; font-weight: bold;'>
