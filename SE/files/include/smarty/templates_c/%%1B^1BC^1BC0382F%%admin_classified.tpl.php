<?php /* Smarty version 2.6.14, created on 2010-05-26 07:17:42
         compiled from admin_classified.tpl */
?><?php
SELanguage::_preload_multi(4500077,4500078,191,192,4500079,4500080,4500081,4500082,4500083,4500084,104,1202,1203,100,101,140,148,102,173);
SELanguage::load();
...
<h2><?php echo SELanguage::_get(4500077); ?></h2>
<?php echo SELanguage::_get(4500078); ?>
<br />
<br />
...
<table cellpadding='0' cellspacing='0' width='600'>
  ...
  <tr>
    <td class='setting1'><?php echo SELanguage::_get(4500079); ?></td>
  </tr>
  <tr>
    <td class='setting2'>
      <table cellpadding='2' cellspacing='0'>
        <tr>
          <td><input type='radio' name='setting_permission_classified' id='setting_permission_classified_1' value='1'<?php if ($this->_tpl_vars['setting']['setting_permission_classified']): ?> checked<?php endif; ?> /></td>
          <td><label for='setting_permission_classified_1'><?php echo SELanguage::_get(4500080); ?></label></td>
        </tr>
        <tr>
          <td><input type='radio' name='setting_permission_classified' id='setting_permission_classified_0' value='0'<?php if (! $this->_tpl_vars['setting']['setting_permission_classified']): ?> checked<?php endif; ?> /></td>
          <td><label for='setting_permission_classified_0'><?php echo SELanguage::_get(4500081); ?></label></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table cellpadding='0' cellspacing='0' width='600'>
  <tr>
    <td class='header'><?php echo SELanguage::_get(4500082); ?></td>
  </tr>
  <tr>
    <td class='setting1'><?php echo SELanguage::_get(4500083); ?></td>
  </tr>
  <tr>
    <td class='setting2'>
        ...
        &nbsp;
        <?php echo SELanguage::_get(4500084); ?> - <a href='javascript:addcat();'>[<?php echo SELanguage::_get(104); ?>]</a>
      </div>
...
_title'><?php echo SELanguage::_get($this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['subcats'][$this->_sections['subcat_loop']['index']]['subcat_title']); ?></a></span>
            ...
            <a href='admin_fields.php?type=classified&task=addfield&cat_id=<?php echo $this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['cat_id']; ?>
...
' style='vertical-align: middle; margin-right: 5px; cursor: move;' />
                <a href='admin_fields.php?type=classified&task=getfield&field_id=<?php echo $this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['fields'][$this->_sections['field_loop']['index']]['field_id']; ?>
...
' style='padding-top: 3px;'>
                  <div>
                    ...
                    <a href='admin_fields.php?type=classified&task=getdepfield&field_id=<?php echo $this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['fields'][$this->_sections['field_loop']['index']]['field_options'][$this->_sections['dep_field_loop']['index']]['dep_field_id']; ?>
