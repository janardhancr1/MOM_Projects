<?php /* Smarty version 2.6.14, created on 2010-05-26 11:52:52
         compiled from footer.tpl */
?><?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'footer.tpl', 26, false),array('modifier', 'count', 'footer.tpl', 32, false),array('modifier', 'strpos', 'footer.tpl', 34, false),array('modifier', 'strstr', 'footer.tpl', 34, false),array('modifier', 'replace', 'footer.tpl', 34, false),)), $this);
?><?php
SELanguage::_preload_multi(1333,1334,753,754);
SELanguage::load();
?>
...
<div class='red_bar' style='margin-bottom:2px'>
 ...
 <div style='float:left;color:#BEB800'>
  Momburbia TM C <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y') : smarty_modifier_date_format($_tmp, '%Y')); ?>
 &nbsp;
 </div>
   <a href='help.php' class='copyright'><?php echo SELanguage::_get(1333); ?></a> &nbsp;
  <a href='help.php' class='copyright'><?php echo SELanguage::_get(1334); ?></a> &nbsp;
