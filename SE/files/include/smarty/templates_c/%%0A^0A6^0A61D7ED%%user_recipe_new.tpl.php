<?php /* Smarty version 2.6.14, created on 2010-05-29 16:02:49
         compiled from user_recipe_new.tpl */
?><?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'user_recipe_new.tpl', 317, false),)), $this);
?><?php
...
<div class='page_header'>Add Recipe</div>
                        ...
                        <td>
                            <fieldset>
                                <legend class="grayHeader">Recipe Details</legend>
								  ...
								  <br />
								<?php endif; ?>
                                <form action='user_recipe_new.php' method='POST'>
