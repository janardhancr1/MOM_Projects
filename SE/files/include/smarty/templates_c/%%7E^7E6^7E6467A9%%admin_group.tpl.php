<?php /* Smarty version 2.6.14, created on 2010-05-26 07:17:22
         compiled from admin_group.tpl */
?><?php
SELanguage::_preload_multi(2000003,2000073,191,192,2000074,2000075,2000076,2000077,2000078,2000079,2000080,2000330,2000331,2000081,2000082,2000083,104,1202,1203,100,101,140,148,102,173);
SELanguage::load();
...
<h2><?php echo SELanguage::_get(2000003); ?></h2>
<?php echo SELanguage::_get(2000073); ?>
<br />
<br />
...
<td class='setting1'>
  <?php echo SELanguage::_get(2000074); ?>
</td>
</tr>
<tr>
<td class='setting2'>
  ...
  <tr>
  <td><input type='radio' name='setting_permission_group' id='permission_group_1' value='1'<?php if ($this->_tpl_vars['setting']['setting_permission_group'] == 1): ?> CHECKED<?php endif; ?>></td>
  <td><label for='permission_group_1'><?php echo SELanguage::_get(2000075); ?></label></td>
  </tr>
  <tr>
  <td><input type='radio' name='setting_permission_group' id='permission_group_0' value='0'<?php if ($this->_tpl_vars['setting']['setting_permission_group'] == 0): ?> CHECKED<?php endif; ?>></td>
  <td><label for='permission_group_0'><?php echo SELanguage::_get(2000076); ?></label></td>
  </tr>
  </table>
</td>
</tr>
...
<table cellpadding='0' cellspacing='0' width='600'>
<tr>
<td class='header'><?php echo SELanguage::_get(2000077); ?></td>
</tr>
<td class='setting1'>
<?php echo SELanguage::_get(2000078); ?>
</td></tr><tr><td class='setting2'>
  <table cellpadding='0' cellspacing='0'>
  <tr><td><input type='radio' name='setting_group_discussion_code' id='discussion_code_1' value='1'<?php if ($this->_tpl_vars['setting']['setting_group_discussion_code'] == 1): ?> CHECKED<?php endif; ?>>&nbsp;</td><td><label for='discussion_code_1'><?php echo SELanguage::_get(2000079); ?></label></td></tr>
  <tr><td><input type='radio' name='setting_group_discussion_code' id='discussion_code_0' value='0'<?php if ($this->_tpl_vars['setting']['setting_group_discussion_code'] == 0): ?> CHECKED<?php endif; ?>>&nbsp;</td><td><label for='discussion_code_0'><?php echo SELanguage::_get(2000080); ?></label></td></tr>
  </table>
</td></tr></table>
...
<table cellpadding='0' cellspacing='0' width='600'>
<tr>
<td class='header'><?php echo SELanguage::_get(2000330); ?></td>
</tr>
<tr>
<td class='setting1'>
<?php echo SELanguage::_get(2000331); ?>
</td>
</tr>
<tr>
<td class='setting2'>
<input type='text' class='text' name='setting_group_discussion_html' value='<?php echo $this->_tpl_vars['setting']['setting_group_discussion_html']; ?>
...
<table cellpadding='0' cellspacing='0' width='600'>
<tr><td class='header'><?php echo SELanguage::_get(2000081); ?></td></tr>
<tr><td class='setting1'>
<?php echo SELanguage::_get(2000082); ?>
</td></tr><tr><td class='setting2'>


    <div style='font-weight: bold;'>&nbsp;<?php echo SELanguage::_get(2000083); ?> - <a href='javascript:addcat();'>[<?php echo SELanguage::_get(104); ?>]</a></div>
...
_title'><?php echo SELanguage::_get($this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['subcats'][$this->_sections['subcat_loop']['index']]['subcat_title']); ?></a></span></div>
        ...
        <?php endfor; endif; ?>
            ...
            <div style='padding-left: 20px; padding-top: 5px; padding-bottom: 3px;'><?php echo SELanguage::_get(100); ?> - <a href='admin_fields.php?type=group&task=addfield&cat_id=<?php echo $this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['cat_id']; ?>
&hideSearch=1&hideDisplay=1&hideSpecial=1&TB_iframe=true&height=450&width=450' class='smoothbox' title='<?php echo SELanguage::_get(101); ?>'>[<?php echo SELanguage::_get(101); ?>]</a></div>
...
' style='padding-left: 15px; padding-bottom: 3px;'>
            <div><img src='../images/item.gif' border='0' class='handle_field_<?php echo $this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['cat_id']; ?>
' style='vertical-align: middle; margin-right: 5px; cursor: move;'><a href='admin_fields.php?type=group&task=getfield&field_id=<?php echo $this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['fields'][$this->_sections['field_loop']['index']]['field_id']; ?>
&hideSearch=1&hideDisplay=1&hideSpecial=1&TB_iframe=true&height=450&width=450' class='smoothbox' title='<?php echo SELanguage::_get(140); ?>'><?php echo SELanguage::_get($this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['fields'][$this->_sections['field_loop']['index']]['field_title']); ?></a></div>
...
' style='padding-top: 3px;'>
                    <div><img src='../images/item_dep.gif' border='0' class='icon2'><?php echo SELanguage::_get($this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['fields'][$this->_sections['field_loop']['index']]['field_options'][$this->_sections['dep_field_loop']['index']]['label']); ?> <a href='admin_fields.php?type=group&task=getdepfield&field_id=<?php echo $this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['fields'][$this->_sections['field_loop']['index']]['field_options'][$this->_sections['dep_field_loop']['index']]['dep_field_id']; ?>
&hideSearch=1&hideDisplay=1&hideSpecial=1&TB_iframe=true&height=450&width=450' class='smoothbox' title='<?php echo SELanguage::_get(148); ?>' id='dep_field_title_<?php echo $this->_tpl_vars['cats'][$this->_sections['cat_loop']['index']]['fields'][$this->_sections['field_loop']['index']]['field_options'][$this->_sections['dep_field_loop']['index']]['dep_field_id']; ?>
