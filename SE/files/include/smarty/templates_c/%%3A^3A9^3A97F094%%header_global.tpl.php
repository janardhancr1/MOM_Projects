<?php /* Smarty version 2.6.14, created on 2010-05-26 08:01:24
         compiled from header_global.tpl */
?><?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'hook_foreach', 'header_global.tpl', 114, false),)), $this);
?><?php
...
function showPass() {
  var p1 = document.getElementById(\'passid1\');
  var p2 = document.getElementById(\'passid2\');
