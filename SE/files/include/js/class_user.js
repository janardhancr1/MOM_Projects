...
SocialEngineAPI.User = new Class({
  ...
  userStatusChange: function()
  {
    ...
    var statusHTML = " <input type='text' class='user_status_new' name='status_new' id='status_new' maxlength='100' value='";
    
    statusHTML += ( userStatus=='' ? this.Base.Language.Translate(744) : userStatus );
    statusHTML += "' size='10' onkeypress='return ( (new Event(event)).key==\"enter\" ? SocialEngine.Viewer.userStatusChangeSubmit() : true );'>" +
      "<br />";
  ...
  userStatusChangeHome: function()
  {
    if( !$('ajax_status') ) return false;
    
    var userStatus = this.user_status.replace(/<wbr>/g, '').replace(/&shy;/g, '');
    
    var statusHTML = " <input type='text' class='user_status_new_home' name='status_new' id='status_new' maxlength='100' value='";
    
    statusHTML += ( userStatus=='' ? this.Base.Language.Translate(1344) : userStatus );
    statusHTML += "' size='10' onkeypress='return ( (new Event(event)).key==\"enter\" ? SocialEngine.Viewer.userStatusChangeHomeSubmit() : true );'>" +
      "<br />";
  ...
  userStatusChangeHomeSubmit: function()
  {
    if( !$('ajax_status') ) return false;
