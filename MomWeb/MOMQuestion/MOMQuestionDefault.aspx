<%@ Page Language="C#" MasterPageFile="~/MOMMaster/MasterPage.master" AutoEventWireup="true" CodeFile="MOMQuestionDefault.aspx.cs" Inherits="MOMQuestion_MOMAsk" %>
...
<asp:Content ContentPlaceHolderID="momCenter" ID="momCenterContent" runat="server">
    ...
    <asp:HiddenField ID="momStartIndex" runat="server" />
    <asp:HiddenField ID="momEndIndex" runat="server" />
</asp:Content>
