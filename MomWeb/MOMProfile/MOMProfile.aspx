                                            ...
                                            <td>
                                                <table cellpadding="3" width="100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <a href="?muI=<%# MOMHelper.Encrypt(DataBinder.Eval(Container.DataItem, "MOM_USR_ID").ToString()) %>"
                                                                    style="font-weight: bold;">
                                                                    <%# MOMHelper.HTMLEncode(DataBinder.Eval(Container.DataItem, "DISPLAY_NAME").ToString()) %>
                                                                </a>
                                                                <%# MOMHelper.BreakText(MOMHelper.HTMLEncode(DataBinder.Eval(Container.DataItem, "SHARE").ToString()), 50)%>
                                                            </div>
                                                            <div>
                                                                <small>
                                                                                        ...
                                                                                        <table width="100%" cellspacing="0" cellpadding="3">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="commentStyle">
                                                                                                    ...
                                                                                                    <%# MOMHelper.BreakText(MOMHelper.HTMLEncode(DataBinder.Eval(Container.DataItem, "COMMENTS").ToString()), 40)%>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="commentStyle">
                            ...
                            <table width="100%">
                                <tr>
                                    <td>
                                        Sex:</td>
                                    <td>
                                        <asp:Label ID="momInfoUserSex" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>
                                        Birth Day:</td>
                                    <td>
                                        <asp:Label ID="momInfoUserBirthday" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>
                                        Email Address:</td>
                                    <td>
                                        <asp:Label ID="momInfoUserEmail" runat="server"></asp:Label></td>
                                </tr>
                            </table>
                            <br />
                        </fieldset>
